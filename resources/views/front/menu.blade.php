    ...
    <header class="navbar navbar-sticky">
      ...
      <div class="site-branding">
        <div class="inner">
          ...
          <!-- Site Logo--><a class="site-logo" href="{{url('/')}}"><img src="{{URL::asset('dist/img/logo/logo.png')}}" alt="Unishop"></a>
      ...
      <nav class="site-menu">
        <ul>
          ...
          <li><a href="{{url('/shop')}}"><span>Shop</span></a>
            <ul class="sub-menu">
                <li><a href="shop-categories.html">Shop Categories</a></li>
      ...
      <div class="toolbar">
        <div class="inner">
          <div class="tools">
            ...
            <div class="cart"><a href="{{url('/cart')}}"></a><i class="icon-bag"></i><span class="count">({{Cart::count()}})  </span><span class="subtotal">({{Cart::total()}})</span>
